...
; which system call the process is request for has already been placed in eax. so, there 
; is nothing to be done here, just an "ret" instruction to return the call_num to c language.
